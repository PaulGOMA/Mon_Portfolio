...
export default function Infocard() {
    ...
    return <aside className="Infocard-container">
        ...
        <div >
            <img src="https://github.com/PaulGOMA/Mon_Portfolio/blob/main/react_release/src/assets/Profil_photo.jpg" alt = "Profile picture of Paul Valerie GOMA" width="250" height="auto" className='picture'/> 
        </div>
